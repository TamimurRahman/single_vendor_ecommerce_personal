    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('delivered', 'Delivered'), ('processing', 'Processing'), ('canceled', 'Canceled'), ('pending', 'Pending'), ('shipped', 'Shipped')], default='pending', max_length=10)),
